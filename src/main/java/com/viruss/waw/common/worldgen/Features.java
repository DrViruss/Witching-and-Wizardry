...
public class Features {
    ...
    public static class Trees{
        ...
        public static final ConfiguredFeature<TreeConfiguration, ?> ASH = registerWorldFeature("ash", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(ModRegistry.WOOD.ASH.getLog().getPrimary().defaultBlockState()), new FancyTrunkPlacer(3, 11, 0), new SimpleStateProvider(ModRegistry.WOOD.ASH.getLeaves().getPrimary().defaultBlockState()), new SimpleStateProvider(ModRegistry.WOOD.ASH.getSapling().getPrimary().defaultBlockState()), new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 4), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines().build()));
        public static final ConfiguredFeature<TreeConfiguration, ?> SAMBUCUS = registerWorldFeature("sambucus", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(ModRegistry.WOOD.SAMBUCUS.getLog().getPrimary().defaultBlockState()), new FancyTrunkPlacer(4, 2, 0), new SimpleStateProvider(ModRegistry.WOOD.SAMBUCUS.getLeaves().getPrimary().defaultBlockState()), new SimpleStateProvider(ModRegistry.WOOD.SAMBUCUS.getSapling().getPrimary().defaultBlockState()), new FancyFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 6), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines().build()));
